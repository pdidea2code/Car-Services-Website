...
const editAppSetting = async (req, res, next) => {
  try {
    ...
    appSetting.smtp_host = req.body.smtp_host ? req.body.smtp_host : appSetting.smtp_host;
    appSetting.smtp_port = req.body.smtp_port ? req.body.smtp_port : appSetting.smtp_port;
    appSetting.google_client_id = req.body.google_client_id ? req.body.google_client_id : appSetting.google_client_id;
    appSetting.service_tax = req.body.service_tax ? req.body.service_tax : appSetting.service_tax;
