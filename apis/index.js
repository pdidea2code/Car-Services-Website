...
app.use(
  "/userprofileimg",
  express.static(path.join(__dirname, "./public/userprofileimg/"))
);
app.use(
  "/showcaseimg",
  express.static(path.join(__dirname, "./public/showcaseimg/"))
);
app.use(
  "/serviceimg",
  express.static(path.join(__dirname, "./public/serviceimg/"))
);
app.use(
  "/addonsimg",
  express.static(path.join(__dirname, "./public/addonsimg/"))
);
app.use(
  "/appsettingimg",
  express.static(path.join(__dirname, "./public/appsettingimg/"))
);
app.use("/blogimg", express.static(path.join(__dirname, "./public/blogimg/")));
app.use(
  "/userthemeimg",
  express.static(path.join(__dirname, "./public/userthemeimg/"))
);
