        ...
        <Container> 
            <Row className="footer-row">
                <Col className="footer-col1" xs={12} md={6} lg={5}>
                    ...
                    <div >
                    {appSetting && <img src={appSetting?.footerlogo} alt="logo" style={{width: "auto", height: "auto"}} />}
                    </div>
                    <div className="footer-text-div">
                    <span className="footer-text">Thank you for visiting us. We are committed to providing exceptional service and value to our customers.</span>
                    </div>
                ...
                <Col className="footer-col2" xs={12} md={6} lg={4}>
                    ...
                    <div className="footer-col2-text-div d-flex flex-column gap-2">
                        {businessHour.map((item, index) => (
                            <div className="d-flex gap-2 align-items-center"><DeshlineIcon className="deshline-icon" /> <span className="footer-text-hour">{item.day}</span></div>
                        ))}
                   
                    </div>
                    <div className="footer-col2-text-div d-flex flex-column gap-2">
                        {businessHour.map((item, index) => (
                            item.is_closed ? <span className="footer-text-hour">Closed</span> : <span className="footer-text-hour">{dayjs("09:00", "HH:mm").format("h:mm A")} - {dayjs(item.close, "HH:mm").format("h:mm A")}</span>
                        ))}
                ...
                <Col className="footer-col3" xs={12} md={6} lg={3}>
                    ...
                    <div className="footer-col3-links-div">
                       <div className="d-flex gap-2 align-items-center"><DeshlineIcon className="deshline-icon" /> <span className="footer-col3-link">Home</span></div>
                        <div className="d-flex gap-2 align-items-center"><DeshlineIcon className="deshline-icon" /> <span className="footer-col3-link">Services</span></div>
                        <div className="d-flex gap-2 align-items-center"><DeshlineIcon className="deshline-icon" /> <span className="footer-col3-link">Booking</span></div>
                        <div className="d-flex gap-2 align-items-center"><DeshlineIcon className="deshline-icon" /> <span className="footer-col3-link">Blog</span></div>
                        <div className="d-flex gap-2 align-items-center"><DeshlineIcon className="deshline-icon" /> <span className="footer-col3-link">Contact Us</span></div>
                    </div>
                    </div>
                </Col>
            </Row>
