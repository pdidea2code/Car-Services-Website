...
import {
  SafetyGuaranteeIcon,
  SkilledProfessionalsIcon,
  ClearPricingIcon,
  ClientAssistanceIcon,
        ...
        <Row>
          <Col xl={4} lg={6} md={12} className="d-flex ">
            <div data-aos="fade-up" className="choose-us-title-container">
              ...
              <BlurText
                delay={10}
                className="choose-us-title2 zen-dots"
                text="Experience Excellence With Our Unique Offerings"
              />
              <BlurText
                delay={20}
                className="choose-us-title3 k2d"
                text="Elevate Your Experience with Our Exclusive Products And Services, Designed To Meet The Highest Standards. Enjoy Unmatched Quality And Satisfaction With Every Offering."
              />
              <button
                onClick={() => {
                  navigate("/contact");
                }}
                className="choose-us-button btn-4 zen-dots"
              >
                Contact US
              </button>
            </div>
          ...
          <Col xl={4} lg={6} md={12} className="">
            <div data-aos="fade-up" className="choose-us-image-container">
              <img src={theme?.workingimage} alt="choose us" className="choose-us-image" />
            </div>
          </Col>
            ...
            <Row className="choose-us-points-row">
              <Col xl={12} lg={6} md={12} className="choose-us-point" data-aos="fade-up">
                ...
                <div className="choose-us-point-title">
                  <span className="choose-us-point-title-text k2d">Safety Guarantee</span>
              ...
              <Col xl={12} lg={6} md={12} className="choose-us-point" data-aos="fade-up" data-aos-delay="100">
                ...
                <div className="choose-us-point-title">
                  <span className="choose-us-point-title-text k2d">Skilled Professionals</span>
                  <span className="choose-us-point-title-text2 k2d">
              ...
              <Col xl={12} lg={6} md={12} className="choose-us-point" data-aos="fade-up" data-aos-delay="200">
                ...
                <div className="choose-us-point-title">
                  <span className="choose-us-point-title-text k2d">Clear Pricing</span>
                  <span className="choose-us-point-title-text2 k2d">
              ...
              <Col xl={12} lg={6} md={12} className="choose-us-point" data-aos="fade-up" data-aos-delay="300">
                ...
                <div className="choose-us-point-title">
                  <span className="choose-us-point-title-text k2d">Client Assistance</span>
                  <span className="choose-us-point-title-text2 k2d">
