            ...
            <CCardBody>
              <CForm className="row g-3" onSubmit={handleSubmit(onSubmit)}>
                <CCol xl={12} md={12}>
                  ...
                  />
                  {errors.title && <CFormFeedback className="text-danger">{errors.title?.message}</CFormFeedback>}
                </CCol>
                ...
                <CCol xl={12} md={12}>
                   ...
                   />
                   {errors.description && <CFormFeedback className="text-danger">{errors.description?.message}</CFormFeedback>}
                </CCol>
                <CCol xl={12} md={12}>   
                    <CFormInput
                    type="file"
                    ...
                    {...register('image', image ? { required: false } : { required: 'Blog Image is required' })}
                    invalid={!!errors.image}
                    onChange={(e) => handleSingleImgChange(e)}
                    />
                    {errors.image && <CFormFeedback className="text-danger">{errors.image?.message}</CFormFeedback>}
                </CCol>
                {image && <CCol xl={12} md={12}>

                    <img src={image} alt="Blog Image" style={{ width: 'auto', maxWidth: '100%', objectFit: 'cover' }} />
                    </CCol>
                }
                <CCol xl={12} md={12}>
                    <CFormLabel>Blog Content</CFormLabel>
                       <Controller
                        ...
                        control={control}
                        defaultValue=""
                        render={({ field }) => <ReactQuill {...field} theme="snow" onChange={field.onChange} modules={{ toolbar: toolbarOptions }} />}
                    />
                </CCol>
