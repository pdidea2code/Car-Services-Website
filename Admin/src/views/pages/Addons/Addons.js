import { getAllAddonsApi, editAddonsApi, deleteAddonsApi, getAddonsByServiceApi } from '../../../redux/api/api'
...
const Addons = () => {
  ...
  const handleDeleteAddons = async (id) => {
    try {
      const response = await deleteAddonsApi(id)
      if (response.status === 200) {
      ...
      options: {
        ...
        customBodyRender: (value, { rowIndex }) => {
          ...
          return (<div className="d-flex gap-2">
            ...
            }} color="error"><Icons.DeleteRounded /></Button>
            <Button onClick={() => navigate(`/addons/form`, { state: data })} className="editButton"><Icons.EditRounded /></Button>
