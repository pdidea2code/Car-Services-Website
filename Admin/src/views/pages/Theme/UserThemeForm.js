              ...
              <CForm className="row g-3" onSubmit={handleSubmit(onSubmit)}>
                ...
                <CCol xl={12} md={12}>
                  <CFormInput
                    ...
                    {...register('headerimage', { required: 'Page Header Image is required' })}
                    onChange={(e) => handleSingleImgChange(e, 'headerimage')}
                  />
                  {errors.headerimage && (
                    <p className="text-danger">{errors.headerimage.message}</p>
                  )}
                  {headerimage && (
                    <img src={headerimage} alt="headerimage" style={{ maxWidth: '100%' }} />
                  )}
                </CCol>
                ...
                <CCol xl={12} md={12}>
                  <CFormInput
                    ...
                    {...register('workingimage', {
                      required: 'Why Choose Us Section Image is required',
                    })}
                    onChange={(e) => handleSingleImgChange(e, 'workingimage')}
                  />
                  {errors.workingimage && (
                    <p className="text-danger">{errors.workingimage.message}</p>
                  )}
                  {workingimage && (
                    <img src={workingimage} alt="workingimage" style={{ maxWidth: '100%' }} />
                  )}
                </CCol>
                ...
                <CCol xl={12} md={12}>
                  <CFormInput
                    type="file"
                    label=" Home Page Discount Section Image"
                    {...register('springimage', {
                      required: 'Home Page Discount Section Image is required',
                    })}
                    onChange={(e) => handleSingleImgChange(e, 'springimage')}
                  />
                  {errors.springimage && (
                    <p className="text-danger">{errors.springimage.message}</p>
                  )}
                  {springimage && (
                    <img src={springimage} alt="springimage" style={{ maxWidth: '100%' }} />
                  )}
                </CCol>
